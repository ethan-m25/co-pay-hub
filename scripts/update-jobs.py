#!/usr/bin/env python3
"""
co-pay-hub/scripts/update-jobs.py
Daily job data updater — Colorado Pay Hub edition.

Reads raw JSONL files from ~/.openclaw/shared/co-jobs-raw-*.txt,
...
def classify_job(job: dict) -> dict:
    ...
    job["_width"] = width
    job["_compliant"] = True   # CO EPEWA — all postings must comply
