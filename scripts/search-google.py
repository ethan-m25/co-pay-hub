#!/usr/bin/env python3
# co-pay-hub/scripts/search-google.py
# Google Careers scraper for CO. USD salary: CO EPEWA strictest — all remote postings open to CO must disclose

LOG_FILE  = "/Users/clawii/co-pay-hub/scripts/google.log"
LOCK_FILE = "/Users/clawii/co-pay-hub/scripts/.google.lock"
...
REGION_TERMS     = ['denver', 'boulder', 'fort collins', 'aurora', 'colorado springs', 'broomfield', 'longmont', ', co,', ', co ', 'colorado']
NON_REGION_TERMS = []
CITY_MAP         = {'denver': 'Denver, CO', 'boulder': 'Boulder, CO', 'fort collins': 'Fort Collins, CO', 'aurora': 'Aurora, CO', 'colorado springs': 'Colorado Springs, CO', 'broomfield': 'Broomfield, CO'}
