#!/usr/bin/env python3
"""
co-pay-hub/scripts/search-amazon.py
Amazon Jobs scraper — CO edition.

Strategy: Query amazon.jobs/en/search.json for CO locations.
...
LOG_FILE  = os.path.expanduser("~/co-pay-hub/scripts/amazon.log")
LOCK_FILE = os.path.expanduser("~/co-pay-hub/scripts/.amazon.lock")
...
QUERY_LOCATIONS = ['Denver, Colorado, USA', 'Boulder, Colorado, USA', 'Colorado Springs, Colorado, USA', 'Virtual Location - Colorado, USA']

REGION_TERMS = ['colorado', 'denver', 'boulder', 'colorado springs', 'aurora', 'fort collins', 'arvada', ', co']

CITY_MAP = {'denver': 'Denver, CO', 'boulder': 'Boulder, CO', 'colorado springs': 'Colorado Springs, CO', 'aurora': 'Aurora, CO', 'fort collins': 'Fort Collins, CO'}
...
def main():
    ...
    log("=== Amazon Jobs CO scraper started ===")
    ...
    log(f"=== Amazon CO scraper complete: {total_found} new jobs ===")
    return 0
